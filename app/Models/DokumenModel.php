...
class DokumenModel extends Model
{
	...
	{
		$sql  = 'SELECT YEAR(TANGGAL_DAFTAR) AS TAHUN, MONTH(TANGGAL_DAFTAR) AS BULAN, COUNT(NOMOR_DAFTAR) AS JUMLAH_DOKUMEN FROM TPB_HEADER WHERE YEAR(TANGGAL_DAFTAR) = ? AND KODE_DOKUMEN = ? GROUP BY YEAR(TANGGAL_DAFTAR), MONTH(TANGGAL_DAFTAR) ORDER BY MONTH(TANGGAL_DAFTAR) ASC';
		$sqld = 'SELECT YEAR(TANGGAL_DAFTAR) AS TAHUN, MONTH(TANGGAL_DAFTAR) AS BULAN, COUNT(NOMOR_DAFTAR) AS JUMLAH_DOKUMEN FROM TPB_DETAIL WHERE YEAR(TANGGAL_DAFTAR) = ? AND KODE_DOKUMEN= ? GROUP BY YEAR(TANGGAL_DAFTAR), MONTH(TANGGAL_DAFTAR) ORDER BY MONTH(TANGGAL_DAFTAR) ASC';
