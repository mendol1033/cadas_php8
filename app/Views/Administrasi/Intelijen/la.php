            ...
            <div class="panel-hdr">
                ...
                <div class="panel-toolbar">
                    <div class="panel-toolbar flex-row-reverse">
                        ...
                        <button id="LI" class="btn btn-primary btn-pills btn-xs waves-effect waves-themed" data-toggle="tooltip" data-offset="0,10" style="width: 90; margin-right: 15px;"><i class="fal fa-file"></i> &nbsp;Buat Baru</button>
                    </div>
                </div>
            </div>
...
<div class="modal fade" id="modalLi" tabindex="-1" role="dialog" aria-modal="true" data-backdrop="false">
            ...
            <div class="modal-body">
                <form class="needs-validation" id="formLI" novalidate enctype="multipart/form-data">
                    <div class="row">
                        ...
                        <div class="col-xl-4">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control tanggal" id="TANGGAL" name="TANGGAL" required>
                            </div>
                        </div>
                        <div class="col-xl-4">
                            <div class="form-group">
                                <label class="form-label" for="JENIS">Jenis</label>
                                <select class="select2 form-control" id="JENIS" name="JENIS" required>
                    ...
                    <div class="row">
                        <div class="col-xl-4">
                            <div class="form-group">
                                <label class="form-label" for="JENIS_DOK">JENIS DOKUMEN</label>
                                <select class="select2 form-control" id="JENIS_DOK" name="JENIS_DOK">
                                </select>
                                <div class="invalid-feedback">
                                    Kolom Jenis Dokumen Harus Diisi.
                                </div>
                            </div>
                        </div>
                        <div class="col-xl-4">
                            <div class="form-group">
                                <label class="form-label" for="NOMOR_DOK">NOMOR DOKUMEN</label>
                                <input type="text" class="form-control" id="NOMOR_DOK" name="NOMOR_DOK" required>
                                <div class="invalid-feedback">
                                    Kolom Nomor Dokumen Harus Diisi.
                                </div>
                            </div>
                        </div>
                        <div class="col-xl-4">
                            <div class="form-group">
                                <label class="form-label" for="TANGGAL_DOK">TANGGAL DOKUMEN</label>
                                <input type="text" class="form-control tanggal" id="TANGGAL_DOK" name="TANGGAL_DOK">
                                <div class="invalid-feedback">
                                    Kolom Tanggal Dokumen Harus Diisi.
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    $("#LI").on('click', function(event) {
        ...
        $(".modal-title").text('Input Data Laporan Analisa');
        $("#modalLi").modal('show');
        console.log($('[name="TUJUAN_DISPOSISI"]').parent());
    });
