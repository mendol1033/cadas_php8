...
<body class="mod-bg-1 desktop chrome webkit pace-done nav-function-top blur">
                ...
                <aside class="page-sidebar">
                    <div class="page-logo">
                        <a href="#" class="page-logo-link press-scale-down d-flex align-items-center position-relative" data-toggle="modal" data-target="#modal-shortcut">
                            ...
                            <span class="page-logo-text mr-1"><?php echo $title;?></span>
                    ...
                    <nav id="js-primary-nav" class="primary-nav" role="navigation">
                        ...
                        <ul id="js-nav-menu" class="nav-menu">
                            ...
                            <li>
                                <a href="Index" title="Aplikasi" data-filter-tags="Aplikasi">
                                    <i class="fas fa-desktop"></i>
                                    <span class="nav-link-text" data-i18n="nav.Aplikasi">Aplikasi</span>
                                </a>
                                <!-- <ul>
                                    <li>
                                        <a href="javascript:void(0)" title="Input LogBook" data-filter-tags="Aplikasi Input LogBook" onclick="loadPage('Ki/LogBook')">
                                            <span class="nav-link-text" data-i18n="nav.Log_Book_Input_LogBook">Input Logbook</span>
                                        </a>
                                    </li>
                                </ul> -->
                            </li>
                            <li>
                                <a href="<?php echo $base_url; ?> " title="Profile" data-filter-tags="Profile">
                                    <i class="fas fa-user-tie"></i>
                                    <span class="nav-link-text" data-i18n="nav.Profile">Profile</span>
                                </a>
                            </li>
                            <?php if (in_array(1, $_SESSION['hakAkses'])) {?>
                                <li class="nav-title">Admin Menu</li>
                                <li>
                                    <a href="javascript:void(0)" title="Manajemen Aplikasi" data-filter-tags="Manajemen Aplikasi">
                                        <i class="fal fa-user"></i>
                                        <span class="nav-link-text" data-i18n="nav.Manajemen_Akses">Manajemen Akses</span>
                                    </a>
                                    <ul>
                                        <li>
                                            <a href="javascript:void(0)" title="Manajemen Pegawai" data-filter-tags="Manajemen Aplikasi Manajemen Pegawai" onclick="loadPage('pegawai')">
                                                <span class="nav-link-text" data-i18n="nav.Manajemen_Akses_Manajemen_Pegawai">Manajemen Pegawai</span>
                                            </a>
                                        </li>
                                        <li>
                                            <a href="javascript:void(0)" title="Manajemen User" data-filter-tags="Manajemen Aplikasi Manajemen User" onclick="loadPage('pegawai/user')">
                                                <span class="nav-link-text" data-i18n="nav.Manajemen_Akses_Manajemen_User">Manajemen User</span>
                                            </a>
                                        </li>
                                        <li>
                                            <a href="javascript:void(0)" title="Manajemen Hanggar" data-filter-tags="Manajemen Aplikasi Manajemen Hanggar" onclick="loadPage('pegawai/manajemenHanggar')">
                                                <span class="nav-link-text" data-i18n="nav.Manajemen_Akses_Manajemen_Hanggar">Manajemen Hanggar</span>
                                            </a>
                                        </li>
                                    </ul> 
                                </li>
...
<!--                             <div class="hidden-sm-up">
                                    ...
                                    <div id="mainDeck" class="panel">
                                        ...
                                        <div class="panel-container show">
                                            <div class="panel-content">
                                                <div class="card-deck">                                                
                                                    <?php if (isset($_SESSION['hakAkses'])) { ?>
                                                        <?php for ($h = 0; $h < count($_SESSION['hakAkses']); $h++) { ?>
                                                            <?php foreach ($_SESSION['menu'] as $key=>$value) {?>
                                                                <?php if ((int)$value['appCode'] === (int)$_SESSION['hakAkses'][$h] ) {?>
    ...
    <audio id="notification" class="sr-only"><source src="assets/media/sound/smallbox.mp3" type="audio/mp3"><source src="assets/media/sound/smallbox.ogg" type="audio/ogg"></audio>
        <!-- END Page Settings -->
<!-- base vendor bundle: 
