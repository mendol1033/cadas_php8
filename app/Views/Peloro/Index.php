...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="assets/css/fa-light.css">
    <link rel="stylesheet" type="text/css" href="assets/css/fa-regular.css">
    <link rel="stylesheet" type="text/css" href="assets/css/formplugins/bootstrap-datepicker/bootstrap-datepicker.css">
    ...
    <link rel="stylesheet" media="screen, print" href="assets/js/statistics/Highcharts/code/css/highcharts.css">
    ...
    <script>
        ...
        <div class="page-wrapper">
            <div class="page-inner">
                <!-- BEGIN Left Aside Navigation Bar Left -->
                <aside class="page-sidebar">
                    <div class="page-logo">
                        <a href="#" class="page-logo-link press-scale-down d-flex align-items-center position-relative" data-toggle="modal" data-target="#modal-shortcut">
                            ...
                            <span class="position-absolute text-white opacity-50 small pos-top pos-right mr-2 mt-n2">AlphaProject</span>
                    ...
                    <nav id="js-primary-nav" class="primary-nav" role="navigation">
                        ...
                        <div class="info-card">
                            <img src="assets/img/demo/avatars/avatar.png" class="profile-image rounded-circle" alt="<?php echo $_SESSION['NamaPegawai'];?>">
                            <div class="info-card-text">
                                <a href="#" class="d-flex align-items-center text-white">
                                    <span class="text-truncate text-truncate-sm d-inline-block">
                                        <?php echo ucwords(strtolower($_SESSION['NamaPegawai'])) ;?>
                                    </span>
                                </a>
                                <span class="d-inline-block text-truncate text-truncate-sm">Bekasi, Indonesia</span>
                            </div>
                        ...
                        <ul id="js-nav-menu" class="nav-menu">
                            <?php if (isset($menu)) { ?>
                                ...
                                <?php foreach ($menu as $key=>$value) {?>
                                    <li>
                                        <a href="javascript:void(0)" title="<?php echo $value['appTitle'];?>" data-filter-tags="<?php echo $value['appTitle'];?>">
                                            <i class="<?php echo $value['appIcon'];?>"></i>
                                            <span class="nav-link-text" data-i18n="nav.<?php echo str_replace(" ", "_", $value['appTitle']) ;?>"><?php echo $value['appTitle'];?></span>
                                        </a>
                                        <?php if(isset($value['subMenu'])){?>
                                            <ul>
                                                <?php for ($i = 0; $i < count($value['subMenu']); $i++) {?>
                                                    <li>
                                                        <a href="javascript:void(0)" title="<?php echo $value['subMenu'][$i]['title'];?>" data-filter-tags="<?php echo $value['appTitle'].' '.$value['subMenu'][$i]['title'];?>" onclick="loadPage('<?php echo $value["subMenu"][$i]["link"];?>')">
                                                            <span class="nav-link-text" data-i18n="nav.<?php echo str_replace(' ', '_', $value['appTitle']).'_'.$value['subMenu'][$i]['title'] ;?>"><?php echo $value['subMenu'][$i]['title'];?></span>
                                                        </a>
                                                    </li>
                                                <?php } ?>
                                            </ul>
                                ...
                                <?php } ?>                                    
                            <?php } ?>
                            <?php if (isset($_SESSION['adminMenu'])) { ?>
                                <li class="nav-title">Administrator Menu</li>
                                <?php foreach ($_SESSION['adminMenu'] as $key => $value) { ?>
                                    <li>
                                        <a href="javascript:void(0)" title="<?php echo $value['appTitle'];?>" data-filter-tags="<?php echo $value['appTitle'];?>">
                                            <i class="<?php echo $value['appIcon'];?>"></i>
                                            <span class="nav-link-text" data-i18n="nav.<?php echo str_replace(" ", "_", $value['appTitle']) ;?>"><?php echo $value['appTitle'];?></span>
                ...
                <div class="page-content-wrapper">
                       ...
                       <!--  <div class="search">
                        ...
                        <div class="ml-auto d-flex">
                          ...
                          <!--   <a href="#" class="header-icon" data-toggle="modal" data-target=".js-modal-messenger">
                                            ...
                                            <div class="custom-scroll h-100">
                                                <ul class="notification">
                                                    ...
                                                    <li>
                                                        <a href="#" class="d-flex align-items-center">
                                                            <span class="status status-success mr-2">
                                                                <img src="assets/img/demo/avatars/avatar-m.png" data-src="img/demo/avatars/avatar-h.png" class="profile-image rounded-circle" alt="Sarah McBrook" />
                            ...
                            <!-- app user menu -->
                            <div>
                                <a href="#" data-toggle="dropdown" title="<?php echo $_SESSION['NamaPegawai']?>" class="header-icon d-flex align-items-center justify-content-center ml-2">
                                ...
                                <div class="dropdown-menu dropdown-menu-animated dropdown-lg">
                                    <div class="dropdown-header bg-trans-gradient d-flex flex-row py-4 rounded-top">
                                        <div class="d-flex flex-row align-items-center mt-1 mb-1 color-white">
                                            ...
                                            <div class="info-card-text">
                                                <div class="fs-lg text-truncate text-truncate-lg"><?php echo ucwords(strtolower($_SESSION['NamaPegawai']));?></div>
                                                <span class="text-truncate text-truncate-md opacity-80"><?php echo $_SESSION['NipUser'];?></span>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <a class="dropdown-item fw-500 pt-3 pb-3" href="Logout">
                                        ...
                                        <span class="float-right fw-n">&commat;<?php echo $_SESSION['NamaUser'];?></span>
                                    </a>
                                </div>
                            </div>
                        </div>
                    ...
                    <main id="js-page-content" role="main" class="page-content">
                        <ol class="breadcrumb page-breadcrumb">
                            <li class="breadcrumb-item"><a href="javascript:void(0);">Cadas</a></li>
                            <li class="breadcrumb-item">Form Stuff</li>
                            <li class="breadcrumb-item active sr-only">Basic Inputs</li>
                            <li class="position-absolute pos-top pos-right d-none d-sm-block"><span class="js-get-date">Saturday, March 28, 2020</span></li>
                        </ol>
                        <div class="subheader">
                    ...
                    <!-- END Page Footer -->
                    <!-- BEGIN Shortcuts MODAL SHORTCUT TOP -->
...
<audio id="notification" class="sr-only">
    <source src="assets/media/sound/smallbox.mp3" type="audio/mp3">
        <source src="assets/media/sound/smallbox.ogg" type="audio/ogg">
        </audio>
        <!-- END Page Settings -->
<!-- base vendor bundle: 
    ...
    <script src="assets/js/statistics/Highcharts/code/highcharts.js"></script>
    <script src="assets/js/statistics/Highcharts/code/highcharts-3d.js"></script>
    <script src="assets/js/statistics/Highcharts/code/highcharts-more.js"></script>
    <script src="assets/js/statistics/Highcharts/code/modules/data.js"></script>
    <script src="assets/js/statistics/Highcharts/code/modules/series-label.js"></script>
    <script src="assets/js/statistics/Highcharts/code/modules/exporting.js"></script>
    <script src="assets/js/statistics/Highcharts/code/modules/export-data.js"></script>
    <script src="assets/js/statistics/Highcharts/code/modules/accessibility.js"></script>
    <script src="assets/js/miscellaneous/number-format/src/format.js"></script>
            ...
            if (l !== '#') {
                $.ajax({
                    ...
                    success: function(data){
                        ...
                        $('.subheader').append('<h1 class="subheader-title"><i class="subheader-icon '+data.subheader.icon+'"></i>'+data.subheader.title+'<small>'+data.subheader.detail+'</small></h1>');
                        $('.page-breadcrumb').append('<li class="breadcrumb-item"><a href="javascript:void(0);">'+data.main+'</a></li>');
                        if (typeof data.sub !== 'undefined') {
                            $('.page-breadcrumb').append('<li class="breadcrumb-item">'+data.sub+'</li>');
                        }
                        $('.page-breadcrumb').append('<li class="breadcrumb-item active">'+data.active+'</li>');
                        $('.page-breadcrumb').append('<li class="position-absolute pos-top pos-right d-none d-sm-block"><span class="js-get-date">'+data.date.hari+', '+data.date.tanggal+'-'+data.date.bulan+'-'+data.date.tahun+'</span></li>');
