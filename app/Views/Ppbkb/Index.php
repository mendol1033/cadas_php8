...
<body class="mod-bg-1 header-function-fixed nav-function-fixed nav-function-top">
                        ...
                        <ul id="js-nav-menu" class="nav-menu">
                            <?php if (isset($menu)) { ?>
                                ...
                                <?php foreach ($menu['menu'] as $key=>$value) {?>
                                    <?php for ($i = 0; $i < count($value['aksesCode']); $i++) { ?>
                                        <?php if($k = array_search($value['aksesCode'][$i], $_SESSION['hakAkses']) !== FALSE){ ?>
                                            <li>
                                                <a href="javascript:void(0)" title="<?php echo $value['appTitle'];?>" data-filter-tags="<?php echo $value['appTitle'];?>" onclick="loadPage('<?php echo $value["link"];?>')">
                                ...
                                <?php } ?>                                    
                            <?php } ?>
                            <?php if ($k = array_search(1, $_SESSION['hakAkses']) !== FALSE) { ?>
                                <li class="nav-title">Administrator Menu</li>
                                <?php foreach ($menu['admin'] as $key => $value) { ?>
                                   <?php if($k = array_search($value['aksesCode'], $_SESSION['hakAkses']) !== FALSE || $value['aksesCode'] == 0){ ?>
                                    <li>
                                        <a href="javascript:void(0)" title="<?php echo $value['appTitle'];?>" data-filter-tags="<?php echo $value['appTitle'];?>" onclick="loadPage('<?php echo $value['link'];?>')">
                                            <i class="<?php echo $value['appIcon'];?>"></i>
                                            <span class="nav-link-text" data-i18n="nav.<?php echo str_replace(" ", "_", $value['appTitle']) ;?>"><?php echo $value['appTitle'];?></span>
                ...
                <header class="page-header" role="banner">
                    ...
                    <main id="js-page-content" role="main" class="page-content">
                        <ol class="breadcrumb page-breadcrumb">
                            ...
                            <li class="breadcrumb-item">PPB-KB</li>
                            <li class="breadcrumb-item active">Dashboard</li>
                            <li class="position-absolute pos-top pos-right d-none d-sm-block"><span class="js-get-date"><?php date("l, F d, Y");?></span></li>
                        </ol>
                        <div id="content">
