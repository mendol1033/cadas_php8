        ...
        <div class="position-absolute pos-top pos-bottom w-100">
            <div class="d-flex h-100 flex-column">
                ...
                <div class="flex-1 pr-3">
                    <a href="javascript:void(0)" onclick="load_profile_page()" class="dropdown-item px-3 px-sm-4 pr-lg-3 pl-lg-5 py-2 fs-md font-weight-bold d-flex justify-content-between rounded-pill border-top-left-radius-0 border-bottom-left-radius-0 active">
                        <div>
                            <i class="fas fa-industry-alt width-1"></i>Profil Perusahaan
                        </div>
                        <div class="fw-400 fs-xs js-unread-emails-count"></div>
                    </a>
                    <a href="javascript:void(0)" onclick="load_profile_page()" class="dropdown-item px-3 px-sm-4 pr-lg-3 pl-lg-5 py-2 fs-md d-flex justify-content-between rounded-pill border-top-left-radius-0 border-bottom-left-radius-0">
                        <div>
                            <i class="fa fa-file-user width-1"></i>Daftar Pengurus Perusahaan
                        </div>
                    </a>
                    <a href="javascript:void(0)" onclick="load_profile_page()" class="dropdown-item px-3 px-sm-4 pr-lg-3 pl-lg-5 py-2 fs-md d-flex justify-content-between rounded-pill border-top-left-radius-0 border-bottom-left-radius-0">
                        <div>
                            <i class="fas fa-file-alt width-1"></i>Daftar SKEP TPB
                        </div>
    ...
    <div class="d-flex flex-column flex-grow-1 bg-white">
        ...
        <div class="flex-grow-0">
            ...
            <div class="d-flex align-items-center pl-2 pr-3 py-3 pl-sm-3 pr-sm-4 py-sm-4 px-lg-5 py-lg-4  border-faded border-top-0 border-left-0 border-right-0 flex-shrink-0">
                ...
                <h1 id="subtitle" class="subheader-title ml-1 ml-lg-0">
