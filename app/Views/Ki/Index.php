                ...
                <aside class="page-sidebar">
                    ...
                    <nav id="js-primary-nav" class="primary-nav" role="navigation">
                        ...
                        <ul id="js-nav-menu" class="nav-menu">
                            ...
                            <li>
                                <a href="javascript:void(0)" title="Kinerja" data-filter-tags="Kinerja" onclick="loadPage('#')">
                                    <i class="fas fa-chart-line"></i>
                                    <span class="nav-link-text" data-i18n="nav.Kinerja">Kinerja</span>
                                </a>
                                <ul>
                                    <li>
                                        <a href="javascript:void(0)" title="Input LogBook" data-filter-tags="Kinerja Kontrak Kinerja" onclick="loadPage('Ki/KontrakKinerja')">
                                            <span class="nav-link-text" data-i18n="nav.Kinerja_Kontrak_Kinerja">Kontrak Kinerja</span>
                                        </a>
                                    </li>
                                </ul>
                            </li>
                            <li>
                                <a href="javascript:void(0)" title="Log Book" data-filter-tags="Log Book" onclick="loadPage('#')">
                                    <i class="fas fa-book"></i>
                                    <span class="nav-link-text" data-i18n="nav.Log_Book">Log Book</span>
                                </a>
                                <ul>
                                    <li>
                                        <a href="javascript:void(0)" title="Input LogBook" data-filter-tags="Log Book Input LogBook" onclick="loadPage('Ki/LogBook')">
                                            <span class="nav-link-text" data-i18n="nav.Log_Book_Input_LogBook">Input Logbook</span>
                                        </a>
                                    </li>
                                </ul>
                            </li>
                            <?php if ($_SESSION['GrupMenu'] == 1 || $_SESSION['GrupMenu'] == 10) { ?>
                             <?php if (in_array(1, $_SESSION['hakAkses'])) {?>
                                <li class="nav-title">Admin Menu</li>
                                <li>
                                    <a href="javascript:void(0)" title="IKU" data-filter-tags="IKU" onclick="loadPage('#')">
                                        <i class="fas fa-list"></i>
                                        <span class="nav-link-text" data-i18n="nav.IKU">IKU</span>
                                    </a>
                                    <ul>
                                        <li>
                                            <a href="javascript:void(0)" title="Input Iku Baru" data-filter-tags="IKU Input Iku Baru" onclick="loadPage('Ki/IkuBaru')">
                                                <span class="nav-link-text" data-i18n="nav.IKU_Input_Iku_Baru">Input Iku Baru</span>
                                            </a>
                                        </li>
                                    </ul>
                                </li>
