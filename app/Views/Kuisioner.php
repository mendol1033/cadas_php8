                ...
                <aside class="page-sidebar">
                    ...
                    <nav id="js-primary-nav" class="primary-nav" role="navigation">
                        ...
                        <ul id="js-nav-menu" class="nav-menu js-nav-built">
                            ...
                            <li>
                                <a href="http://localhost:8080/Kuisioner" title="Home" data-filter-tags="Home" class=" waves-effect waves-themed">
                                    <i class="fas fa-home"></i>
                                    <span class="nav-link-text" data-i18n="nav.Home">Home</span>
                                </a>
                            </li>
                            <li>
                                <a href="javascript:void(0)" title="dampakEkonomi" data-filter-tags="Dampak Ekonomi" class=" waves-effect waves-themed" onclick="loadPage('Kuisioner/dampakEkonomi')">
                                    <i class="fas fa-file"></i>
                                    <span class="nav-link-text" data-i18n="nav.dampakEkonomi">Kuisioner Dampak Ekonomi</span>
                                </a>
                                <!-- <ul>
                                    <li>
                     ...
                     <!--        <li class="nav-title">Admin Menu</li>
                            <li>
                                <a href="javascript:void(0)" title="Manajemen Aplikasi" data-filter-tags="Manajemen Aplikasi" class=" waves-effect waves-themed">
                                    ...
                                    <ul>
                                        <li>
                                            <a href="javascript:void(0)" title="Manajemen Pegawai" data-filter-tags="Manajemen Aplikasi Manajemen Pegawai" onclick="loadPage('pegawai')" class=" waves-effect waves-themed">
                                                <span class="nav-link-text" data-i18n="nav.Manajemen_Akses_Manajemen_Pegawai">Manajemen Pegawai</span>
                                            </a>
                                        </li>
                                        <li>
                                            <a href="javascript:void(0)" title="Manajemen User" data-filter-tags="Manajemen Aplikasi Manajemen User" onclick="loadPage('pegawai/user')" class=" waves-effect waves-themed">
